...
coletor/sonda_parametros.py descobre por tentativa os valores que um relatório aceita
coletor/produtos.py        cadastro do ERP: coleção, subcoleção, tipo, grupo, marca
